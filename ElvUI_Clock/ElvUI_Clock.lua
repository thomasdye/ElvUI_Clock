...
function TimeDisplayAddon:PLAYER_LOGIN()
    ...
    local function OpenSettingsWindow()
        ...
        local function InitializeLeftClickDropdown(self, level)
            local info = UIDropDownMenu_CreateInfo()
            local options = {"Calendar", "Friends", "Character", "Spellbook", "Talents", "Achievements", "Quests", "Guild", "Dungeon Finder", "Raid Finder", "Collections", "Shop", "Stopwatch", "Map", "Professions", "None"}
